...
public class DeliveryTaskController {
    ...
    public ResponseEntity<DeliveryTaskResponseDto> createDeliveryTask(
            ...
            @org.springframework.web.bind.annotation.RequestBody CreateDeliveryTaskRequestDto deliveryTaskRequestDto) {
    ...
    public ResponseEntity<Optional<DeliveryTaskResponseDto>> updateDeliveryTaskStatus(
            @Parameter(description = "ID of the delivery task") @PathVariable String id,
            @RequestBody(description = "New status details")
            @org.springframework.web.bind.annotation.RequestBody UpdateDeliveryStatusRequestDto statusDto) {
    ...
    public ResponseEntity<List<DeliveryTaskResponseDto>> getDeliveryTasksByCourierId(
            @Parameter(description = "ID of the courier") @PathVariable String courierId) {
    ...
    public ResponseEntity<List<DeliveryTaskResponseDto>> getDeliveryTasksByStatus(
            @Parameter(description = "Delivery status filter") @PathVariable DeliveryStatus status) {
    ...
    public ResponseEntity<DeliveryTaskResponseDto> updateDeliveryTaskLocation(
            ...
            @org.springframework.web.bind.annotation.RequestBody LocationUpdateDto locationUpdateDto) {
        ...
        return ResponseEntity.ok(deliveryTaskService.updateDeliveryTaskLocation(
                id, locationUpdateDto.getLatitude(), locationUpdateDto.getLongitude()));
    }
    ...
    public ResponseEntity<CancelDeliveryTaskResponseDto> cancelDeliveryTask(
            ...
            @org.springframework.web.bind.annotation.RequestBody CancelDeliveryTaskRequestDto cancelTaskDto) {
    ...
    public ResponseEntity<SubmitCourierRatingResponseDto> submitCourierRating(
            ...
            @org.springframework.web.bind.annotation.RequestBody SubmitCourierRatingRequestDto ratingDto) {
